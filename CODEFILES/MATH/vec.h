...
*/
__inline FLT VecDot( VEC V1, VEC V2 )
{
...
*/
__inline VEC VecCross( VEC V1, VEC V2 )
{
 ...
 *   (VEC) result vector.
 */
__inline VEC VecMin( VEC V1, VEC V2 )
{
 ...
 *   (VEC) result vector.
 */
__inline VEC VecMax( VEC V1, VEC V2 )
{
  return VecSet(V1.X > V2.X ? V1.X : V2.X,
                V1.Y > V2.Y ? V1.Y : V2.Y,
                V1.Z > V2.Z ? V1.Z : V2.Z);
